...
pencilPopperShowEvents.forEach(event => pencilButton.addEventListener(event, show(pencilTooltip, pencilPopper)));
pencilPopperHideEvents.forEach(event => pencilButton.addEventListener(event, hide(pencilTooltip)));
